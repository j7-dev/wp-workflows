...
> **錄影畫質規範**：所有錄影必須為 **1080P (1920x1080)**。Playwright 錄影解析度跟隨 viewport，因此**第 2 步的 `resize 1920 1080` 是強制規範**，不可省略也不可降低——它直接決定了錄影畫質。若未來 playwright-cli 提供 `video-start` 的解析度參數，仍須鎖定 1920x1080。
