...
description: TypeScript / React 18 編碼標準與最佳實踐，適用於 WordPress Plugin 前端（Ant Design、Refine.dev、Jotai）。供 react-reviewer agent 審查時參考，也可作為開發時的規範指引。當開發或審查任何 React/TypeScript 程式碼、建立新元件、重構前端、或需要確認命名與型別慣例時，請啟用此技能。
---
